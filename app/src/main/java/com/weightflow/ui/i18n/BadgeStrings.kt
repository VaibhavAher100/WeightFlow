...
object BadgeStrings {
    fun resFor(badge: Badge): BadgeRes = when (badge) {
        ...
        Badge.SEVEN_DAY_STREAK ->
            BadgeRes(R.string.badge_seven_day_streak_name, R.string.badge_seven_day_streak_desc)
        Badge.THIRTY_DAY_STREAK ->
            BadgeRes(R.string.badge_thirty_day_streak_name, R.string.badge_thirty_day_streak_desc)
        Badge.HUNDRED_DAY_STREAK ->
            BadgeRes(R.string.badge_hundred_day_streak_name, R.string.badge_hundred_day_streak_desc)
        ...
        Badge.THREE_SIXTY_FIVE_LOGS ->
            BadgeRes(R.string.badge_three_sixty_five_logs_name, R.string.badge_three_sixty_five_logs_desc)
